...
<head>
     ...
     <title>Project Tracker IndoRAJ</title>
<!--
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            <a class="navbar-brand" href="/">
                <img src="{{ asset('Logo PT IAM.png') }}" alt="Indoraj Job Manager" style="height: 100px;">
                    JobManager
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a href="https://wa.link/ry68b7" class="nav-link smoothScroll">Get Help</a>
                    </li>
                    <li class="nav-item">
                        <a href="https://www.indorajarsip.id/" class="nav-link">Company Profile</a>
                    </li>
                    <li class="nav-item">
                        <a href="dashboard" class="nav-link contact">Dashboard</a>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-10 col-12 d-flex flex-column justify-content-center align-items-center">
                              <div class="hero-text">
                                   ...
                                   <h1 class="text-white" data-aos="fade-up">Satu Aplikasi, Semua Pekerjaan Terkendali</h1>

                                   <a href="/dashboard" class="custom-btn btn-bg btn mt-3" data-aos="fade-up" data-aos-delay="100">Get Started</a>
                        ...
                        <div class="col-lg-6 col-12">
                          <div class="hero-image" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <img src="hero-property (1).webp" class="img-fluid" alt="working girl">
                          </div>
                        </div>
               ...
               <div class="row">
                    ...
                    <div class="col-lg-7 mx-auto col-md-10 col-12">
                         <div class="about-info">
                              ...
                              <h2 class="mb-4" data-aos="fade-up">Jadwal <strong>Rapi</strong> Target <strong>Terpenuhi</strong></h2>
