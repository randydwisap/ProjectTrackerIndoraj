...
--
-- Host: 127.0.0.1
-- Generation Time: May 23, 2025 at 08:23 AM
...
CREATE TABLE `marketings` (
  ...
  `total_volume` decimal(20,6) NOT NULL DEFAULT 0.000000,
  `nama_pic` bigint(20) UNSIGNED NOT NULL,
  `project_manager` bigint(20) UNSIGNED NOT NULL,
  `status` enum('Ditolak','In Progress','Pengajuan','Pengerjaan','Persiapan Operasional','Completed') NOT NULL,
  ...
  `nilai_akhir_proyek` decimal(15,2) DEFAULT NULL,
  `ppn` decimal(15,2) DEFAULT NULL,
  `pph` decimal(15,2) DEFAULT NULL,
  `pencairan` decimal(15,2) DEFAULT NULL,
  ...
  `dokumentasi_foto` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  ...
  `note_operasional` longtext DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `marketings` (`id`, `nama_pekerjaan`, `jenis_pekerjaan`, `nama_klien`, `lokasi`, `tahap_pengerjaan`, `total_volume`, `nama_pic`, `project_manager`, `status`, `durasi_proyek`, `jumlah_sdm`, `nilai_proyek`, `link_rab`, `note`, `tgl_mulai`, `tgl_selesai`, `nilai_akhir_proyek`, `ppn`, `pph`, `pencairan`, `dasar_pengenaan_pajak`, `terms_of_payment`, `status_pembayaran`, `dokumentasi_foto`, `lampiran`, `created_at`, `updated_at`, `manajer_operasional`, `manajer_keuangan`, `note_operasional`) VALUES
(14, 'Pengolahan Arsip Marketing Proyek', 'Pengolahan Arsip', 'Dinas Pendidikan', 'Kota Surabaya', 'Kontrak', 100.000000, 1, 1, 'Pengerjaan', NULL, 1, 150000.00, 'www.projecttracker.hikmahboiler.com', NULL, NULL, NULL, 150000.00, 14864.86, 2702.70, 132432.43, 135135.14, 60, 'Belum Lunas', '[\"marketing_foto\\/marketing_27b56a76-f544-42b5-825b-985a49ec9ecf_fotoabsen_1.jpg\"]', 'marketing_lampiran/01JVXKB7EAYFF6HXXJKJ4KNNPD.pdf', '2025-05-22 20:35:17', '2025-05-22 20:50:47', 1, 1, 'Rules Aturan Operasional :\n1. \n2. \n3.\n4.'),
(15, 'Alih Media Marketing Proyek', 'Alih Media', 'Dinas Pendidikan', 'Kota Surabaya', 'Kontrak', 100.000000, 1, 1, 'Pengerjaan', NULL, 1, 150000.00, 'www.projecttracker.hikmahboiler.com', NULL, NULL, NULL, 150000.00, 14864.86, 2702.70, 132432.43, 135135.14, 60, 'Lunas', '[\"marketing_foto\\/marketing_27b56a76-f544-42b5-825b-985a49ec9ecf_fotoabsen_1.jpg\"]', 'marketing_lampiran/01JVXKB7EAYFF6HXXJKJ4KNNPD.pdf', '2025-05-22 20:35:17', '2025-05-22 21:09:11', 1, 1, 'Rules Aturan Operasional :\n1. \n2. \n3.\n4.');
...
INSERT INTO `settings` (`id`, `ppn`, `pph`, `created_at`, `updated_at`) VALUES
(1, 11, 2, '2025-05-20 08:56:22', '2025-05-20 21:24:23');
...
CREATE TABLE `tasks` (
  ...
  `volume_arsip` decimal(20,6) DEFAULT NULL,
  `volume_dikerjakan` decimal(20,6) DEFAULT NULL,
  `dikerjakan_step1` decimal(20,6) DEFAULT NULL,
  `dikerjakan_step2` decimal(20,6) DEFAULT NULL,
  `dikerjakan_step3` decimal(20,6) DEFAULT NULL,
  `dikerjakan_step4` decimal(20,6) DEFAULT NULL,
  `hasil_pemilahan` decimal(20,6) DEFAULT NULL,
  `jenis_arsip` varchar(255) DEFAULT NULL,
  `deskripsi_pekerjaan` text DEFAULT NULL,
  `lama_pekerjaan` int(11) DEFAULT NULL,
  `total_hari_kerja` int(11) DEFAULT NULL,
  `target_perminggu` decimal(20,6) DEFAULT NULL,
  `target_perminggu_arsip` decimal(20,6) DEFAULT NULL,
  `target_perday` decimal(20,6) DEFAULT NULL,
  `target_perday_arsip` decimal(20,6) DEFAULT NULL,
...
INSERT INTO `tasks` (`id`, `pekerjaan`, `klien`, `tahap_pengerjaan`, `status`, `resiko_keterlambatan`, `durasi_proyek`, `jumlah_sdm`, `project_manager`, `no_telp_pm`, `nilai_proyek`, `link_rab`, `tgl_mulai`, `tgl_selesai`, `created_at`, `updated_at`, `lokasi`, `pelaksana`, `volume_arsip`, `volume_dikerjakan`, `dikerjakan_step1`, `dikerjakan_step2`, `dikerjakan_step3`, `dikerjakan_step4`, `hasil_pemilahan`, `jenis_arsip`, `deskripsi_pekerjaan`, `lama_pekerjaan`, `total_hari_kerja`, `target_perminggu`, `target_perminggu_arsip`, `target_perday`, `target_perday_arsip`, `marketing_id`) VALUES
(92, 'Pengolahan Arsip Marketing Proyek', 'Dinas Pendidikan', 'Pemilahan dan Identifikasi', 'Far Behind Schedule', 'High', 5, 1, 1, '081', 150000.00, NULL, '2025-05-23', '2025-06-23', '2025-05-22 20:50:44', '2025-05-22 20:54:32', 'Kota Surabaya', '[{\"nama\":\"Test\"}]', 100.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 'Campuran', 'Test2', 31, 23, 80.000000, 0.000000, 17.391304, 0.000000, 14);
...
INSERT INTO `task_alih_media` (`id`, `pekerjaan`, `klien`, `tahap_pengerjaan`, `status`, `resiko_keterlambatan`, `durasi_proyek`, `jumlah_sdm`, `project_manager`, `no_telp_pm`, `nilai_proyek`, `link_rab`, `tgl_mulai`, `tgl_selesai`, `created_at`, `updated_at`, `lokasi`, `pelaksana`, `volume_arsip`, `volume_dikerjakan`, `dikerjakan_step1`, `dikerjakan_step2`, `dikerjakan_step3`, `dikerjakan_step4`, `jenis_arsip`, `deskripsi_pekerjaan`, `lama_pekerjaan`, `total_hari_kerja`, `target_perminggu`, `target_perday`, `marketing_id`) VALUES
(74, 'Alih Media Marketing Proyek', 'Dinas Pendidikan', 'Scanning', 'Far Behind Schedule', 'Low', 1, 1, 1, '081', 150000.00, NULL, '2025-05-23', '2025-05-23', '2025-05-22 21:09:11', '2025-05-22 21:09:13', 'Kota Surabaya', '[{\"nama\":\"Test\"}]', 100.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 'Campuran', 'Test', 0, 1, 400.000000, 400.000000, 15);
...
CREATE TABLE `task_day_alih_media` (
  ...
  `output` decimal(20,6) NOT NULL DEFAULT 0.000000,
...
CREATE TABLE `task_day_details` (
  ...
  `hasil_inarsip` decimal(20,6) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `task_week_alih_media` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `total_volume` decimal(20,6) NOT NULL DEFAULT 0.000000,
  `volume_dikerjakan` decimal(20,6) NOT NULL DEFAULT 0.000000,
  `total_step1` decimal(20,6) DEFAULT NULL,
  `total_step2` decimal(20,6) DEFAULT NULL,
  `total_step3` decimal(20,6) DEFAULT NULL,
  `total_step4` decimal(20,6) DEFAULT NULL,
...
INSERT INTO `task_week_alih_media` (`id`, `task_alih_media_id`, `nama_week`, `status`, `resiko_keterlambatan`, `created_at`, `updated_at`, `total_volume`, `volume_dikerjakan`, `total_step1`, `total_step2`, `total_step3`, `total_step4`, `hari_kerja`) VALUES
(88, 74, 'Week 1', 'Far Behind Schedule', 'High', '2025-05-22 21:09:13', '2025-05-22 21:09:13', 400.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 1);
...
CREATE TABLE `task_week_overviews` (
  ...
  `volume_dikerjakan` decimal(20,6) NOT NULL DEFAULT 0.000000,
  `target_minggu` decimal(20,6) NOT NULL DEFAULT 0.000000,
  `arsip` decimal(20,6) NOT NULL DEFAULT 0.000000,
  `inarsip` decimal(20,6) NOT NULL DEFAULT 0.000000,
  `total_step1` decimal(20,6) DEFAULT NULL,
  `total_step2` decimal(20,6) DEFAULT NULL,
  `total_step3` decimal(20,6) DEFAULT NULL,
  `total_step4` decimal(20,6) DEFAULT NULL
...
INSERT INTO `task_week_overviews` (`id`, `task_id`, `nama_week`, `status`, `resiko_keterlambatan`, `created_at`, `updated_at`, `total_volume`, `hari_kerja`, `volume_dikerjakan`, `target_minggu`, `arsip`, `inarsip`, `total_step1`, `total_step2`, `total_step3`, `total_step4`) VALUES
(155, 92, 'Week 1', 'Far Behind Schedule', 'High', '2025-05-22 20:50:47', '2025-05-22 20:50:47', 86.956522, 5, 0.000000, 86.956522, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000),
(156, 92, 'Week 2', 'Far Behind Schedule', 'High', '2025-05-22 20:50:48', '2025-05-22 20:50:48', 86.956522, 5, 0.000000, 86.956522, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000),
(157, 92, 'Week 3', 'Far Behind Schedule', 'High', '2025-05-22 20:50:49', '2025-05-22 20:50:49', 69.565217, 4, 0.000000, 69.565217, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000),
(158, 92, 'Week 4', 'Far Behind Schedule', 'High', '2025-05-22 20:50:50', '2025-05-22 20:50:50', 104.347826, 6, 0.000000, 104.347826, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000),
(159, 92, 'Week 5', 'Far Behind Schedule', 'High', '2025-05-22 20:50:52', '2025-05-22 20:50:52', 52.173913, 3, 0.000000, 52.173913, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000);
...
(1, 'Super Admin', '123', '123', 'admin@email.com', NULL, '$2y$12$mOJsDcuDUOezXhHMazkX.OIy2crsfy7qKE7tAoIUCJob4.2bQUCj.', 'i0XWYhyUN10YPlQGGfHqrIkHxr21RYpwotV9tsiMqHVSjhxvr5eaHsZJY5iT', '2025-03-03 16:51:43', '2025-03-15 01:05:59', 'Manajer Keuangan', '081'),
