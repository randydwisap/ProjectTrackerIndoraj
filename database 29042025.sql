...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 28, 2025 at 10:30 PM
...
CREATE TABLE `tasks` (
  ...
  `durasi_proyek` int(11) DEFAULT NULL,
  `jumlah_sdm` int(11) NOT NULL,
  `project_manager` bigint(20) UNSIGNED NOT NULL DEFAULT 0,
...
(1, 'Manajer Operasional', '', '', 'admin@email.com', NULL, '$2y$12$mOJsDcuDUOezXhHMazkX.OIy2crsfy7qKE7tAoIUCJob4.2bQUCj.', 'Q0hdNfc7dXKgCY8PnOSP4hLuKA5THGOTk3N59IF2jmIXm3kvoeDFpQiwS2sV', '2025-03-03 16:51:43', '2025-03-15 01:05:59', NULL, '081'),
(2, 'Randy Dwi Saputra', '', '', 'randy@email.com', NULL, '$2y$12$gqb.X0rbm99a2WcNt1FBZeYk7O99ZgqYAi/vLK/rQ/460tH6hbGOi', NULL, '2025-03-03 16:54:50', '2025-03-04 08:53:48', NULL, '082'),
(3, 'Manajer Keuangan', '', '', 'rundoy@gmail.com', NULL, '$2y$12$vNY.t5sRlOzdVIES6MAgxuUzGWtbKYzl3F4EtOCLxSVW/gEtHkdLO', NULL, '2025-03-03 18:19:47', '2025-03-03 18:19:47', NULL, '083'),
(4, 'rundoy12', '', '', 'rundoy12@gmail.com', NULL, '$2y$12$mtzo8G8JX8WsHT7RGJuHG.t8tLrnHq7VNAtltUV/wR9fHr4hKZfOO', NULL, '2025-03-03 18:21:07', '2025-03-03 18:21:07', NULL, '084'),
(5, 'randy', '', '', 'rundoyyyy@gmail.com', NULL, '$2y$12$wgY3./ygZ07/FuUJsE702OF6saMLQ/tFpLvHLlegiR0RmdTzo3MDK', NULL, '2025-03-03 18:21:30', '2025-03-03 18:21:30', NULL, '085');
...
--
ALTER TABLE `task_week_overviews`
  ADD CONSTRAINT `task_week_overviews_task_id_foreign` FOREIGN KEY (`task_id`) REFERENCES `tasks` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
